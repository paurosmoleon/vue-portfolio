    ...
    <section id="Contact" class="py-32 h-3/4 md:w-auto  w-[390px] flex flex-col items-center justify-center">
        ...
        <div class="container grid md:grid-cols-2  grid-cols-1  text-white ">
            ...
            <div class="flex flex-col  gap-6 md:pt-0 pt-10 md:w-auto w-1/2 mx-auto">
                <h3 class="text-xl">Send me a message</h3>
                <form @submit.prevent="sendMessage" method="post" class="flex flex-col gap-5">
                    ...
                    <button type="submit"  class="p-4 bg-sky-400 rounded-lg text-neutral-950 font-bold active:opacity-80" >Send Message</button>
                </form>
            </div>
        </div>
    </section>
