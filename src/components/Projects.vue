...
const projects = ref([
  {
    ...
    description: "A machine learning platform for predictive analytics",
  ...
  },
  {
    ...
    image: "../../public/image.jpg",
    description: "Decentralized marketplace built on Ethereum",
    techs: ["Go"]
  },
  {
    id: 3,
    ...
    image: "../../public/image.jpg",
    description: "Connected device ecosystem for modern homes",
    techs: ["etc","etc","etc"]
  },
])
      ...
      <div class="text-white" >
        <div class="flex md:flex-row  flex-col justify-around items-center opacityProject " v-for="project in projects" v-show="project === projects[currentIndex]">
          ...
          <div class=" flex flex-col gap-10  ">
            ...
            <button class=" w-32 h-8 mx-auto bg-cyan-400 text-black font-bold  text-center rounded-md hover:bg-opacity-80 transition duration-300 text-base ">View Project</button>
          </div>
